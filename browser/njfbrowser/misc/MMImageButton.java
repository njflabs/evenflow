...
public class MMImageButton extends Component {

    public MMImageButton(String s, Image image1) {
        colorfilter = new MMDarkenFilter();
        clicked = false;
        entered = false;
        enabled = true;
        label = s;
        image = image1;
        name = "MMImageButton" + nameCounter++;
        super.setName(name);
    ...
    private static final String base = "MMImageButton";
