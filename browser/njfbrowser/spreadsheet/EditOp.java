...
public class EditOp implements ActionListener {
    ...
    public void fill() {
        ...
        if (table.getSelectedRowCount() != 0) {
            ...
            tableModel.fillRange(range, fillValue);  // i added this from below
...
*/
    ...
    public void find(boolean newValue) {
        ...
        if (newValue) {
            ...
            FindDialog findDialog = new FindDialog(adminapp, findValue, matchCase, matchCell);
            findDialog.pack();
