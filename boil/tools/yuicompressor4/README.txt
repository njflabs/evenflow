...
ExpressionWeb is used to edit most .html pages in the assets folder, the adminApp docs folder etc.
The RemoveVTI class is used to remove _vti folders and file Byte Order Marks created by ExpressionWeb.