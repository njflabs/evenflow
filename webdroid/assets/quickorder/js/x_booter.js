...
if(pid == "index_main") {
pid = "aa-edit-shops";
JSSHOP.loadScript("js/x_aa-edit-shops.js", JSSHOP.checkLoader,"js");
...
JSSHOP.loadScript('js/x_itemplug.js', doFrmQLoad,'js');

};

var doMenuLoad = function(thePath, theMessage, thearr) {
JSSHOP.loadScript("js/x_menu.js", doIPGLoad,"js");
};

var doSpinLoad = function(thePath, theMessage, thearr) {
JSSHOP.loadScript("js/js_spinner.js", doMenuLoad,"js");
};



var doPidLoad = function(thePath, theMessage, thearr) {
JSSHOP.loadScript("js/x_" + pid + ".js", doSpinLoad,"js");
};
...
JSSHOP.loadScript("js/aa-" + usrlang + ".js", doPidLoad,"js");
};
...
JSSHOP.loadScript('css/x_admn.css', JSSHOP.checkLoader,'css');
}
} catch(e) {
alert("doBootLoad error: " + e)
}
...
doLANG("js/x_all.js?v=4", doLANG,"js");
...
var aLoadModSettings = function() {
 JSSHOP.loadScript("js/x_aa-mod-settings.js", JSSHOP.checkLoader,"js");
};
