...
function actb(obj,ca,arrTitles,tepCatArrTtl,tepCatArrKwds,tepFdsArrTtl,tepFdsArrKwds){
  ...
  // dDiv.style.top  = "4px";
		...
		dDiv.className = "bigtable bkgdClrNrml brdrClrDlg txtSmall txtBold mintwofh highZ tatCross";
...
var getItemIcon = function(theType) { 
	...
	theSKey = theSTypeSplit[1]; 
      	...
      	switch(theStype) {
		case "noQvalue":
			imgTtlIcon = "rss_xwashed.gif";
			imgTtlStr = "Assort. Feeds";	
			break;
		case "rss":
			imgTtlIcon = "rss_xwashed.gif";
			imgTtlStr = "RSS feed";	
			break;
		case "google+":
			imgTtlIcon = "google_xwashed.gif";	
			imgTtlStr = "google+ feed";
			break;
		case "twitter": 
			imgTtlIcon = "twitter_xwashed.gif";	
			imgTtlStr = "twitter feed";
			break;
		case "bf": // browse feed titles
			imgTtlIcon = "rss_xwashed.gif";
			imgTtlStr = "browse feed categories";	
			break;
		case "uf": // user list
			imgTtlIcon = "rss_xwashed.gif";
			imgTtlStr = "your feed";
		...
		case "uc": // user list
			imgTtlIcon = "rss_xwashed.gif";
			imgTtlStr = "feed category";	
			break;
		case "lc": // user list
			imgTtlIcon = "linkedin_xwashed.gif";
			imgTtlStr = "linkedn feed category";		
			break;
		case "lif": // linkedin feed
			imgTtlIcon = "linkedin_xwashed.gif";
			imgTtlStr = "linkedn feed";	
			break;
		case "tip": // tip box
			// imgTtlIcon = "icons_ep_help.gif";	
 			imgTtlIcon = "favicon.gif";	
			imgTtlStr = "tip";
			break;
		case "jms": // tip box
			imgTtlIcon = "icons_job_market_trans.gif";	
			imgTtlStr = "jobs";
			break;
		default:
			imgTtlIcon = "rss_xwashed.gif";
		...
		return "<img src=\"images/feed_icons/" + imgTtlIcon + "\" align=\"absmiddle\" alt=\"" + imgTtlStr +  "\" title=\"" + imgTtlStr +  "\" class=\"btnRounded\">";
		
};

var getItemTable = function(tmpItitle, tmpIkwrds) {
 
strItable = "<a href=\"javascript:doItemAction('" + tmpItitle + "')\" class=\"txtDecorNone txtClrHdr\"><div class=\"crsrPointer txtSmall txtBold cls_hoover\" style=\"width:100%;\">" + getItemIcon(tmpItitle) + " " + tmpIkwrds + "</div></a>";
