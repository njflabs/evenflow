...
var doAIU = function() {
  ...
  var uploader = new ss.SimpleUpload({
        ...
        onComplete: function( filename, response ) {
            ...
            if ( response.success === true ) {
			if(response.in){finishImgUload(response.in);}
                msgBox.innerHTML = '<i>' + escapeTags( filename ) + '</strong>' + ' successfully uploaded.';

            } else {
                if ( response.msg )  {// 
			
                   msgBox.innerHTML = "qq: " + escapeTags( response.msg );
	finishImgUload(response.msg);
        ...
        onError: function() {
            ...
            msgBox.innerHTML = 'E Unable to upload file';
