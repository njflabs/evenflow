...
var showQbit = function() {
    ...
    tmpScmp = LZString.compressToEncodedURIComponent(tmpSQis);
    tmpSicmp = LZString.compressToEncodedURIComponent(tmpSQias);
   ...
   // alert("tmpS: " + tmpSQis.length + " : " + tmpSQias.length + "\r\n" + tmpSQias);
    ...
    // transRes(tmpSQias);
    // alert("tmpSQis: " + tmpSQis);
    alert("tmpSQias: " + tmpSQis.length + " :: " + tmpSQias.length + " :: " + tmpScmp.length + " :: " + tmpSicmp.length);
    alert("tmpSicmp: " + tmpSicmp);
