...
Context dwetContext;
	...
	imgBtnMMainT = (ImageButton) mDWETFrameLayout.findViewById(R.id.imgBtnMainT);
      imgBtnMMainT.setOnClickListener(new View.OnClickListener() {
	...
	txtVwMEdCntcs = (EditText) mDWETFrameLayout.findViewById(R.id.txtVwEdCntcs);
      ...
      btnMGetContcts.setOnClickListener(new Button.OnClickListener() {
    ...
    imgBtnMHelp.setOnClickListener(new View.OnClickListener() {
        public void onClick(View view) {
    ...
    imgBtnMTxtClr.setOnClickListener(new View.OnClickListener() {
        public void onClick(View view) {
    ...
    imgBtnMFntSize.setOnClickListener(new Button.OnClickListener() {
        public void onClick(View v) {
    ...
    imgMBtnReloadMsgs.setOnClickListener(new Button.OnClickListener() {
        public void onClick(View view) {
    ...
    imgBtnMSendMsg.setOnClickListener(new Button.OnClickListener() {
        public void onClick(View v) {
    ...
    imgBtnMGetScene.setOnClickListener(new Button.OnClickListener() {
        public void onClick(View view) {
