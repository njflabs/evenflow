...
package com.njfsoft_utils.cropimage;
...
public class CropImage extends MonitoredActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.com_njfsoft_utils_cropimage_cropimage);

        mImageView = (CropImageView) findViewById(R.id.crimage);
...
*/
            ...
            if (extras.getString("image-bytes") != null) {
		try {
                  byte[] decodedString = Base64.decode(extras.getString("image-bytes"));
                   mBitmap = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length, null);

                        } catch (Exception e) {

            System.out.println("image-bytes: " + e.toString());
            e.printStackTrace();
                        }
		} else {
	  BitmapDrawable bdBmpTmp = (BitmapDrawable) getApplicationContext().getResources().getDrawable(R.drawable.com_njfsoft_utils_cropimage_indicator_autocrop);
 
	  mBitmap = bdBmpTmp.getBitmap();	
		}	
...
/*
		try {
                    mBitmap = MediaStore.Images.Media.getBitmap(getContentResolver(), Uri.parse(extras.getString("image-path")));
                        } catch (Exception e) {

            System.out.println("mBitmap: " + e.toString());
            e.printStackTrace();
                        }
...
*/
            ...
            mOutputX = Integer.parseInt(extras.getString("mOutputX"));
            System.out.println("extras.getString(mOutputX): " + extras.getString("mOutputX"));
		}
            if (extras.getString("mOutputY") != null) {
            mOutputY = Integer.parseInt(extras.getString("mOutputY"));
		}
...
*/
    ...
    private void startFaceDetection() {
        ...
        mImageView.setImageBitmapResetBase(mBitmap, true);
            ...
            System.out.println("mImageView.setImageBitmapResetBase: " + e.toString());
            e.printStackTrace();
                        }
    ...
    private void onSaveClicked() {
		...
		/*
          ...
          */
				try {
			  Bitmap currBitmap = croppedImage;
			  ...
			  // System.out.println("image-data: " +  encodedImage);
			  ...
			  finish();
				...
				e.printStackTrace();
                    System.out.println("CropImage cant finish: " + e.toString());  //To change body of catch statement use File | Settings | File Templates.
                }
        } else {
