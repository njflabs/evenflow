...
class HighlightView {
    ...
    private void init() {
        ...
        mResizeDrawableWidth =
                resources.getDrawable(R.drawable.com_njfsoft_utils_cropimage_crop_width);
        mResizeDrawableHeight =
                resources.getDrawable(R.drawable.com_njfsoft_utils_cropimage_crop_height);
        mResizeDrawableDiagonal =
                resources.getDrawable(R.drawable.com_njfsoft_utils_cropimage_indicator_autocrop);
    }
