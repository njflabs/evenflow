...
public class UtilWebDialog extends Dialog {
    ...
    public void setPopPage(String theUrl, String theHtml) {
        ...
        if(theHtml.equals("noQvalue") || theHtml.length() < 2) {
            ...
            show();
            strAppData = theHtml;	
		if(theUrl.contains("baseurl")) {
		String fnlPageUrl = fullUrl.replace("baseurl", "");
		epMainWebView.loadDataWithBaseURL(fnlPageUrl, theHtml, "text/html", "utf-8", "");
		} else {	
            epMainWebView.loadData(theHtml, "text/html", null);
		}
        }
