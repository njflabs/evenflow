...
public class AnimEngine{
    ...
    private AnimEngine(ImageView imageView) {
        init(imageView);
    };

    // single instance procedures
    private static AnimEngine sInstance;

    public static AnimEngine getInstance(ImageView imageView) {
        if (sInstance == null)
            sInstance = new AnimEngine(imageView);
    ...
    /**
	* get current frames resource id
	**/
	public int getAEngFrameRes() {
                AnimationFrame frame = mAnimationFrames.get(mIndex);
                return frame.getResourceId();
	}
