...
public final class ViewfinderView extends View {
    ...
    public ViewfinderView(Context context, AttributeSet attrs) {
        ...
        maskColor = Color.parseColor("#60dd1a21");
        resultColor = Color.parseColor("#b0000000");
        frameColor = Color.parseColor("#ffdd1a21");
        laserColor = Color.parseColor("#ffdd1a21");
        resultPointColor = Color.parseColor("#c07FFF00");
    ...
    public void setCutBitmap(Bitmap tCutB) {
        cutBmap = tCutB;
    }

  public List<ResultPoint> getCurrPoints() {
